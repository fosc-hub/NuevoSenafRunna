...
/**
 * Innovación Tab - Direct Component Rendering
 *
 * Renders all 4 workflow sections directly (like MPI pattern):
 * - Intervención (AperturaSection with workflowPhase="innovacion")
 * - Nota de Aval
 * - Informe Jurídico
...
export const InnovacionTab: React.FC<InnovacionTabProps> = ({
  ...
  // Prepare data for AperturaSection (reused for innovacion)
  const aperturaData = {
  ...
  return (
    <Grid container spacing={3}>
      {/* Intervención Section (for Innovación phase) */}
      <Grid item xs={12}>
        <AperturaSection
          data={aperturaData}
          isActive={true}
